...
from expanalysis.utils import load_result, clean_df
from expanalysis.stats import compute_contrast
...
class TestAnalysis(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.csv = os.path.abspath("%s/tests/data/results/stroop_results.csv" %self.pwd)
        self.json = os.path.abspath("%s/tests/data/results/jsPsychData.json" %self.pwd)
        self.tsv = os.path.abspath("%s/tests/data/results/results_df.tsv" %self.pwd)
